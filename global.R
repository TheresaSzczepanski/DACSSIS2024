...
#view(EG6_RE_Loss)
EG6Top_LA_Loss<-Reporting_Cat_Loss("ela", "LA", EG6Top_student_reading_item_perf)
# view(EG6Top_LA_Loss)
EG6Top_RE_Loss<-Reporting_Cat_Loss("ela", "RE", EG6Top_student_reading_item_perf)
# view(EG6Top_RE_Loss)

EG6_CS_Loss<-Practice_Cat_Loss("ela", "Craft and Structure", EG6_student_item_perf)
#view(EG6_CS_Loss)
EG6Top_CS_Loss<-Practice_Cat_Loss("ela", "Craft and Structure", EG6Top_student_reading_item_perf)
#view(EG6Top_CS_Loss)
EG6Mid_CS_Loss<-Practice_Cat_Loss("ela", "Craft and Structure", EG6Mid_student_reading_item_perf)
view(EG6Mid_CS_Loss)
...
EG6Top_ESconv_Loss<-ELA_Subitem_Loss("conv", EG6Top_student_essay_perf)
#view(EG6Top_ESconv_Loss)
EG6Top_ESidea_Loss<-ELA_Subitem_Loss("idea", EG6Top_student_essay_perf)
...
EG5Top_ESconv_Diff<-ELA_Subitem_Diff("conv", EG5Top_student_essay_perf)
#view(EG5Top_ESconv_Diff)
EG5Top_ESidea_Diff<-ELA_Subitem_Diff("idea", EG5Top_student_essay_perf)
...
#view(EG5_CS_Diff)
EG5Top_CS_Diff<-Practice_Cat_Diff("ela", "Craft and Structure", EG5Top_student_reading_item_perf)
#view(EG5Top_CS_Diff)
...
#view(EG5_RE_Loss)
EG5Top_LA_Loss<-Reporting_Cat_Loss("ela", "LA", EG5Top_student_reading_item_perf)
# view(EG5Top_LA_Loss)
EG5Low_LA_Loss<-Reporting_Cat_Loss("ela", "LA", EG5Low_student_reading_item_perf)
# view(EG5Top_LA_Loss)
EG5Top_RE_Loss<-Reporting_Cat_Loss("ela", "RE", EG5Top_student_reading_item_perf)
# view(EG5Top_RE_Loss)
EG5Low_RE_Loss<-Reporting_Cat_Loss("ela", "RE", EG5Low_student_reading_item_perf)
# view(EG5Top_RE_Loss)

EG5_CS_Loss<-Practice_Cat_Loss("ela", "Craft and Structure", EG5_student_item_perf)
#view(EG5_CS_Loss)
EG5Top_CS_Loss<-Practice_Cat_Loss("ela", "Craft and Structure", EG5Top_student_reading_item_perf)
#view(EG5Top_CS_Loss)
EG5Mid_CS_Loss<-Practice_Cat_Loss("ela", "Craft and Structure", EG5Mid_student_reading_item_perf)
#view(EG5Mid_CS_Loss)
...
#view(EG5_VA_Loss)
EG5Low_VA_Loss<-Practice_Cat_Loss("ela", "Vocabulary Acquisition and Use", EG5Low_student_reading_item_perf)
#view(EG5Low_VA_Loss)
...
EG5Top_ESconv_Loss<-ELA_Subitem_Loss("conv", EG5Top_student_essay_perf)
#view(EG5Top_ESconv_Loss)
EG5Top_ESidea_Loss<-ELA_Subitem_Loss("idea", EG5Top_student_essay_perf)
#view(EG5Top_ESidea_Loss)

EG5Low_ESconv_Loss<-ELA_Subitem_Loss("conv", EG5Low_student_essay_perf)
#view(EG5Low_ESconv_Loss)
EG5Low_ESidea_Loss<-ELA_Subitem_Loss("idea", EG5Low_student_essay_perf)
#view(EG5Low_ESidea_Loss)
# Exam Content: G6 ELA
...
EG8Top_RE_Loss<-Reporting_Cat_Loss("ela", "RE", EG8Top_student_reading_item_perf)
 view(EG8Top_RE_Loss)
 EG8Low_RE_Loss<-Reporting_Cat_Loss("ela", "RE", EG8Low_student_reading_item_perf)
 view(EG8Low_RE_Loss)
